...
function DispositionBadge({ disposition }: { disposition?: TicketDisposition | string }) {
...
function ticketHref(ticketId: string) {
  return `/help-and-support/${ticketId}/`;
}
...
export default function TicketTable({
  ...
  const openTicket = (ticketId: string) => {
    router.push(ticketHref(ticketId));
  };
      ...
      <div className="flex flex-wrap items-center gap-2 rounded-xl border border-gray-200 bg-gray-50/60 p-2.5">
        ...
        {isAgent && (
          <HubFilterSelect
            ...
            wrapperClassName="min-w-[11.5rem]"
