      ...
      <div className="main-content">
        ...
        <div className="flex items-center justify-center py-16">
          <div className="text-center">
            <div className="animate-spin rounded-full h-10 w-10 border-b-2 border-purple-600 mx-auto mb-4 opacity-60"></div>
            <p className="text-sm text-gray-600">Loading style code...</p>
          </div>
        </div>
      </div>
    )
    ...
    <div className="main-content">
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-lg font-semibold text-gray-900">Edit Style Code</h1>
        </div>
        <Link
