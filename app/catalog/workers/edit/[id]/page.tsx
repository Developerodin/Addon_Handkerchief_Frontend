      ...
      >
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <input type="text" id="employeeCode" name="employeeCode" className="form-control" value={formData.employeeCode} onChange={handleInputChange} required />
          </div>
          <div className="form-group">
          ...
          <div className="form-group">
            ...
            <input type="text" id="skill" name="skill" className="form-control" value={formData.skill} onChange={handleInputChange} />
          </div>
          <div className="form-group">
            <label htmlFor="shift" className="form-label">Shift</label>
            <input type="text" id="shift" name="shift" className="form-control" value={formData.shift} onChange={handleInputChange} />
          </div>
          <div className="form-group">
