...
export default function Signinbasic() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await dispatch(authActions.login(formData.email, formData.password) as any);
    ...
    <Fragment>
      ...
      <div className="min-h-screen w-full relative flex items-center justify-center">
        ...
        <div
          ...
          style={{ maxWidth: "500px", padding: "60px" }}
        >
          <div className="relative gradient-border-container rounded-[32px]">
            ...
            <div
              className="bg-[#1e1e1e]/80 backdrop-blur-sm rounded-[32px] p-8 relative z-10 transition-all duration-300 hover:shadow-2xl"
              style={{
                boxShadow:
              ...
              <div className="text-center mt-6">
                <p className="text-sm text-gray-400">
                  <Link
                    ...
                    className="text-white ml-1 hover:text-gray-200 transition-colors duration-300"
                  >
                    Forgot Password?
                  </Link>
                </p>
